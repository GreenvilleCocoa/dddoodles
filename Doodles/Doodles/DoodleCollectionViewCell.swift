...
class DoodleCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint(item: self.doodleImageView, attribute: .Width, relatedBy: .Equal, toItem: self.contentView, attribute: .Width, multiplier: 0.95, constant: 0.0).active = true
        NSLayoutConstraint(item: self.doodleImageView, attribute: .Height, relatedBy: .Equal, toItem: self.contentView, attribute: .Height, multiplier: 0.95, constant: 0.0).active = true
    }
